...
This cheatsheet provides a variety of tools and commands to assist with Linux system investigations, whether for security, troubleshooting, performance analysis, or general auditing.
